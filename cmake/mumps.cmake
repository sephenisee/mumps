...
if(given_openblas)
  if(WIN32 AND CMAKE_C_COMPILER_ID STREQUAL "IntelLLVM")
    foreach(i IN ITEMS mumps_common.h)
      file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/windows_intelLLVM/${i} DESTINATION ${_s})
    endforeach()
  endif()
endif()
...
if(given_openblas)
  if(WIN32 AND CMAKE_C_COMPILER_ID STREQUAL "IntelLLVM")
     file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/windows_intelLLVM/mumps_c.c DESTINATION ${_s})
   endif()
endif()
